  ...
  public: {
    Tables: {
      ...
      shot_media_ratings: {
        ...
        Relationships: [
          {
            foreignKeyName: "shot_media_ratings_shot_id_fkey"
            columns: ["shot_id"]
            isOneToOne: false
            referencedRelation: "shots"
            referencedColumns: ["id"]
      ...
      shots: {
        Row: {
          ...
          created_at: string
          final_visual_node_id: string | null
          final_visual_selection_id: string | null
          final_visual_take_id: string | null
          id: string
          order_index: number
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "shots_final_visual_selection_id_fkey"
            columns: ["final_visual_selection_id"]
            isOneToOne: false
            referencedRelation: "decision_notes"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "shots_final_visual_take_id_fkey"
            columns: ["final_visual_take_id"]
            isOneToOne: false
            referencedRelation: "takes"
            referencedColumns: ["id"]
          },
    ...
    Functions: {
      ...
      create_take_with_number: {
        ...
        Returns: {
          ...
          out_shot_id: string
          out_status: string
          out_take_number: number
        }[]
      }
      delete_take_with_approved_guard: {
